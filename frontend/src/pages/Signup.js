...
export default function Signup() {
  ...
  const onClickBackBtn = () => setValues({ ...values, firstPage: true });
  ...
  const toggleMemberHandler = () => navigate("/signin");
      ...
      >
        ...
        {i18n.language === "en" && (
          <div className="signup-form-box">
            <h2 className="form-header">{t("Signup")}</h2>
                  ...
                  <button
                    ...
                    onClick={() => {
                      !(
                        ...
                        setValues({ ...values, firstPage: !values.firstPage });
                    }}
                    disabled={isLoading}
